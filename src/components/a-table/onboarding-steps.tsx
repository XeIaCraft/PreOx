...
export const A_TABLE_ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    description:
      "Une fois en cuisine, le mode recette affiche les étapes une à une avec des minuteurs intégrés — plus besoin de faire défiler tout l'écran les mains pleines.",
  },
  {
    icon: Settings,
