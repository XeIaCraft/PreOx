...
export const VARIANT_SURGERIES: CatalogSurgery[] = [
  ...
  v("Thyroïdectomie par voie endoscopique", "A", "intermediate", "low", "high", false, P, { approach: "endoscopic", family: "thyroidectomie", aka: ["TOETVA", "thyroïdectomie transorale"], h: 2.5, t: G, pos: "Décubitus dorsal, cou en extension", profile: "thyroid" }),
  ...
  v("Myéloméningocèle", "D", "major", "intermediate", "low", false, P, { family: "myelomeningocele", population: "neonate", aka: ["spina bifida"], h: 2, t: G, pos: "Décubitus ventral", closed: true, specifics: ["Intubation en décubitus latéral ou sur appui (protéger la poche) ; allergie au latex à prévenir d'emblée"] }),
  ...
  v("Prothèse trapézo-métacarpienne (rhizarthrose)", "K", "minor", "low", "low", false, P, { family: "rhizarthrose", aka: ["trapézectomie", "rhizarthrose"], h: 1, t: ["superficial_block"], pos: "Décubitus dorsal, bras sur table" }),
  ...
  v("Glossectomie partielle", "C", "intermediate", "low", "high", false, P, { family: "cavite-buccale", aka: ["pelvi-glossectomie"], h: 2, t: G, pos: DORSAL }),
  // Thorax et cardiaque
  ...
  v("Pleurectomie ou pleurodèse chirurgicale", "G", "intermediate", "intermediate", "low", true, IT, { approach: "thoracoscopic", family: "pneumothorax", h: 1.5, t: GD, pos: LATERAL }),
  // Plastique
  ...
  v("Sigmoïdectomie par cœlioscopie", "A", "major", "intermediate", "low", true, UA, { approach: "laparoscopic", family: "colectomie", aka: ["diverticulite", "résection sigmoïdienne"], h: 3, t: G, pos: TREND }),
  v("Hémicolectomie droite par cœlioscopie", "A", "major", "intermediate", "low", true, UA, { approach: "laparoscopic", family: "colectomie", aka: ["colectomie droite coelio"], h: 2.5, t: G, pos: TREND }),
  ...
  v("Bypass gastrique en oméga (mini-bypass)", "A", "major", "intermediate", "low", true, UA, { approach: "laparoscopic", family: "bariatrique-bypass", aka: ["OAGB", "mini gastric bypass"], h: 2, t: G, pos: "Décubitus dorsal, proclive", profile: "bariatric" }),
  ...
  v("Cure de hernie inguinale robot-assistée", "A", "intermediate", "low", "low", false, P, { approach: "robotic", family: "hernie-inguinale", aka: ["TAPP robot", "rTAPP"], h: 1.5, t: G, pos: TREND }),
  ...
  v("Pancréatectomie gauche robot-assistée", "A", "major", "intermediate", "high", true, UA, { approach: "robotic", family: "pancreatectomie-gauche", h: 4, t: G, pos: "Décubitus latéral droit partiel", profile: "major_digestive" }),
  v("Surrénalectomie robot-assistée", "A", "intermediate", "intermediate", "low", true, UA, { approach: "robotic", family: "surrenalectomie", aka: ["phéochromocytome robot"], h: 2.5, t: G, pos: LATERAL }),
  ...
  v("Cystectomie par cœlioscopie", "J2", "major", "intermediate", "high", true, P, { approach: "laparoscopic", family: "cystectomie", h: 5, t: G, pos: LITHO_TREND }),
  ...
  v("Pyéloplastie par cœlioscopie", "J2", "intermediate", "low", "low", false, UA, { approach: "laparoscopic", family: "pyeloplastie", aka: ["syndrome de la jonction"], h: 2.5, t: G, pos: LATERAL }),
  ...
  v("Orchidopexie par cœlioscopie (testicule non palpable)", "J2", "intermediate", "low", "low", false, P, { approach: "laparoscopic", family: "orchidopexie", population: "child", sex: "M", aka: ["Fowler-Stephens", "cryptorchidie"], h: 1.5, t: GB, pos: TREND }),
  ...
  v("Salpingectomie ou kystectomie ovarienne par cœlioscopie", "J1", "intermediate", "low", "low", false, P, { approach: "laparoscopic", family: "annexes", sex: "F", aka: ["kyste de l'ovaire coelio", "salpingectomie"], h: 1, t: G, pos: TREND }),
  v("Torsion d'annexe", "J1", "intermediate", "low", "low", false, P, { approach: "laparoscopic", family: "annexes", sex: "F", aka: ["détorsion ovarienne", "torsion ovarienne"], h: 1, t: G, pos: TREND, specifics: ["Urgence (ischémie ovarienne), souvent jeune femme ou adolescente : estomac plein possible, test de grossesse"] }),
  ...
  // Neurochirurgie
  v("Malformation de Chiari : décompression", "D", "major", "intermediate", "low", false, P, { family: "chiari", aka: ["Chiari", "décompression sous-occipitale"], h: 2.5, t: G, pos: "Décubitus ventral, tête fixée", closed: true, profile: "neurosurgery" }),
  v("Dérivation ventriculo-péritonéale de l'enfant", "D", "intermediate", "low", "low", false, P, { family: "hydrocephalie", population: "child", aka: ["valve", "hydrocéphalie", "révision de valve"], h: 1.5, t: G, pos: "Décubitus dorsal, tête tournée", specifics: ["Dysfonction de valve : hypertension intracrânienne, estomac plein (vomissements) — séquence rapide"] }),
  v("Moelle attachée : libération", "D", "intermediate", "low", "low", false, P, { family: "moelle-attachee", population: "child", aka: ["lipome du cône", "filum terminale"], h: 3, t: G, pos: "Décubitus ventral", specifics: ["Monitorage neurophysiologique : TIVA, pas de curare après l'induction"] }),
  ...
  v("Dérivation lombo-péritonéale", "D", "intermediate", "low", "low", false, P, { family: "hydrocephalie", aka: ["hypertension intracrânienne idiopathique"], h: 1.5, t: G, pos: LATERAL }),
  ...
  v("Valves endobronchiques (réduction de volume)", "G", "minor", "intermediate", "minimal", false, IT, { approach: "endoscopic", family: "emphyseme", aka: ["Zephyr", "valves endobronchiques"], h: 1, t: G, pos: DORSAL, specifics: ["Emphysème sévère : pneumothorax post-geste fréquent (drain à portée), hyperinflation dynamique"] }),
  v("Résection de bulles d'emphysème", "G", "intermediate", "intermediate", "low", true, IT, { approach: "thoracoscopic", family: "emphyseme", aka: ["bullectomie"], h: 2, t: GD, pos: LATERAL, specifics: ["Pas de N₂O ; pressions de ventilation basses (rupture de bulle, pneumothorax sous tension)"] }),
  ...
  v("Canulation d'ECMO", "F", "intermediate", "high", "high", true, P, { approach: "percutaneous", family: "ecmo", aka: ["ECMO veino-artérielle", "ECMO veino-veineuse", "ECLS"], h: 1.5, t: G, pos: DORSAL, specifics: ["Patient en choc ou en hypoxémie réfractaire : anticoagulation, transfusion, embolie gazeuse à la canulation"] }),
