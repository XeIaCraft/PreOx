...
export const EXTRA_SURGERIES = [
  ...
  x("Segmentectomie ou wedge par thoracoscopie", "G", "intermediate", "low", "low", true, IT, { aka: ["wedge", "VATS", "résection atypique", "RATS"], h: 2, t: G, profile: "lung_resection", pos: LATERAL }),
  ...
  x("Chirurgie du pneumothorax", "G", "intermediate", "low", "low", true, IT, { aka: ["bullectomie", "pleurodèse", "abrasion pleurale"], h: 1.5, t: G, pos: LATERAL }),
  ...
  x("Amputation d'orteil ou transmétatarsienne", "A", "minor", "low", "low", false, P, { aka: ["amputation d'orteil", "Lisfranc"], h: 0.75, t: [...SP, ...BL], pos: DORSAL }),
  ...
  x("Sigmoïdectomie", "A", "major", "intermediate", "high", true, UA, { aka: ["colectomie gauche", "diverticulite", "Hartmann"], h: 3, t: G, profile: "major_digestive", pos: "Décubitus dorsal, jambes écartées ou Lloyd-Davies" }),
  ...
  x("Laparotomie exploratrice", "A", "major", "high", "high", true, UA, { aka: ["laparotomie", "abdomen aigu"], h: 2, t: G, pos: DORSAL }),
  ...
  x("Rectopexie", "A", "major", "intermediate", "low", true, UA, { aka: ["prolapsus rectal", "promontofixation rectale"], h: 2.5, t: G, pos: "Décubitus dorsal, Trendelenburg" }),
  ...
  x("Thyroïdectomie totale", "A", "intermediate", "low", "high", false, P, { aka: ["thyroïdectomie totale", "goitre", "cancer thyroïdien"], h: 2, t: G, profile: "thyroid", pos: "Décubitus dorsal, cou en extension" }),
  ...
  x("Mastectomie", "A", "intermediate", "low", "low", false, P, { aka: ["mastectomie totale", "Patey"], h: 1.5, t: G, pos: "Décubitus dorsal, bras en abduction" }),
  ...
  x("Hystérectomie élargie", "J1", "major", "high", "high", true, UA, { aka: ["Wertheim", "cancer du col", "lymphadénectomie pelvienne"], h: 4, t: G, pos: "Lithotomie, Trendelenburg" }),
  ...
  x("Conisation", "J1", "minor", "low", "low", false, P, { aka: ["LEEP", "anse diathermique"], h: 0.5, t: SED, pos: LITHO }),
  ...
  x("Césarienne en urgence", "B", "intermediate", "low", "high", true, P, { aka: ["césarienne code rouge", "césarienne urgente"], h: 0.75, t: SP, profile: "obstetric", pos: "Décubitus dorsal, inclinaison latérale gauche" }),
  x("Césarienne programmée", "B", "intermediate", "low", "high", true, P, { aka: ["césarienne élective"], h: 0.75, t: SP, profile: "obstetric", pos: "Décubitus dorsal, inclinaison latérale gauche" }),
  ...
  x("Curage ganglionnaire cervical", "C", "intermediate", "intermediate", "high", false, P, { aka: ["évidement cervical"], h: 2.5, t: G, pos: "Décubitus dorsal, tête tournée" }),
  ...
  x("Cranioplastie", "D", "intermediate", "low", "low", false, P, { aka: ["volet crânien"], h: 2, t: G, pos: DORSAL }),
  ...
  x("Hernie discale cervicale (arthrodèse antérieure)", "D", "intermediate", "intermediate", "high", false, P, { aka: ["ACDF", "discectomie cervicale"], h: 2, t: G, closed: true, pos: "Décubitus dorsal, cou en extension" }),
  ...
  x("Prothèse unicompartimentale du genou", "K", "intermediate", "intermediate", "high", false, P, { aka: ["PUC", "uni"], h: 1.25, t: [...SP, ...BL], profile: "arthroplasty", pos: DORSAL }),
  x("Prothèse totale de cheville", "K", "intermediate", "low", "low", false, P, { h: 2, t: [...SP, ...BL], pos: DORSAL }),
  x("Prothèse de coude", "K", "intermediate", "low", "low", false, P, { h: 2, t: [...G, ...BL], pos: "Décubitus latéral, bras sur appui" }),
  ...
  x("Enclouage du fémur", "K", "major", "intermediate", "high", false, P, { aka: ["clou fémoral", "fracture de la diaphyse fémorale", "clou gamma long"], h: 1.5, t: G, profile: "arthroplasty", pos: "Table orthopédique" }),
  ...
  x("Fracture de la cheville (bimalléolaire)", "K", "intermediate", "low", "low", false, P, { aka: ["bimalléolaire", "trimalléolaire"], h: 1.25, t: [...SP, ...BL], pos: DORSAL }),
  ...
  x("Arthrodèse lombaire étendue", "K", "major", "intermediate", "high", false, P, { aka: ["scoliose", "correction de déformation", "ostéotomie vertébrale"], h: 5, t: G, closed: true, profile: "arthroplasty", pos: PRONE }),
  x("Chirurgie du rachis mini-invasive", "K", "intermediate", "intermediate", "high", false, P, { aka: ["TLIF", "XLIF", "vis percutanées"], h: 2.5, t: G, closed: true, pos: PRONE }),
