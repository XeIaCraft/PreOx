...
export const EXTRA_SURGERIES = [
  ...
  x("Chirurgie de la paroi thoracique", "G", "major", "intermediate", "high", true, IT, { aka: ["pectus carinatum", "résection costale", "Ravitch"], h: 2.5, t: G, pos: DORSAL }),
  ...
  x("Interruption volontaire de grossesse", "J1", "minor", "low", "low", false, P, { aka: ["IVG", "IMG", "interruption médicale de grossesse", "aspiration"], h: 0.25, t: SED, pos: LITHO }),
  ...
  x("Bloc ou infiltration antalgique", "X", "minor", "low", "low", false, P, { aka: ["infiltration", "radiofréquence facettaire", "rhizolyse", "bloc stellaire"], h: 0.5, t: SED, pos: "Selon le site" }),
