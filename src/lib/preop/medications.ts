...
export const ATC_GROUPS: AtcGroup[] = [
  ...
  { prefix: "L04AF", label: "Inhibiteurs de JAK" },
  { prefix: "R03BB", label: "Anticholinergiques inhalés" },
  { prefix: "C02KX", label: "Traitements de l'hypertension artérielle pulmonaire" },
  { prefix: "H02AA", label: "Minéralocorticoïdes" },
  { prefix: "A10AE", label: "Insulines basales (lentes)" },
  { prefix: "A10AB", label: "Insulines rapides" },
  { prefix: "A10AD", label: "Insulines prémélangées" },
...
export const MEDICATIONS: Medication[] = [
  ...
  { atc: "N03AG01", name: "Acide valproïque", brands: ["Depakine", "Valproate"] },
  ...
  { atc: "C01DX16", name: "Nicorandil", brands: ["Adancor"], components: ["C01DA"] },
  ...
  // Codeine is sold in Belgium as an antitussive (R05DA) but is an opioid all the same.
  { atc: "R05DA04", name: "Codéine", brands: ["Bronchodine", "Toularynx Codeine"], components: ["N02A"] },
  { atc: "N02AA08", name: "Dihydrocodéine", brands: ["Paracodine"] },
  ...
  { atc: "L04AF01", name: "Tofacitinib", brands: ["Xeljanz"] },
  { atc: "L04AF02", name: "Baricitinib", brands: ["Olumiant"] },
  { atc: "L04AF03", name: "Upadacitinib", brands: ["Rinvoq"] },
  { atc: "L04AF04", name: "Filgotinib", brands: ["Jyseleca"] },
  ...
  { atc: "C01DX12", name: "Molsidomine", brands: ["Corvaton", "Coruno"], components: ["C01DA"] },
  ...
  { atc: "L02BG06", name: "Exémestane", brands: ["Aromasin"] },
  { atc: "L01DB01", name: "Doxorubicine", brands: ["Adriamycin", "Caelyx"] },
  { atc: "L01DB03", name: "Épirubicine", brands: ["Farmorubicine"] },
  { atc: "L01DB02", name: "Daunorubicine" },
  { atc: "L01DB06", name: "Idarubicine", brands: ["Zavedos"] },
  { atc: "L01DC01", name: "Bléomycine" },
  { atc: "M05BX04", name: "Dénosumab", brands: ["Prolia", "Xgeva"] },
  // --- Sang ------------------------------------------------------------------------------
  { atc: "B03AA07", name: "Fer oral (sulfate ferreux)", brands: ["Fero-Grad", "Ferogradumet", "Sulfate ferreux"] },
  ...
  { atc: "A11CC05", name: "Colécalciférol (vitamine D)", brands: ["D-Cure", "Vitamine D"] },
  // --- Added (2) --------------------------------------------------------------------
