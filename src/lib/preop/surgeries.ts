...
export const SURGERY_CATALOG: CatalogSurgery[] = [
  ...
  s("Arthrodèse rachidienne", "K", "major", "intermediate", "high", false, "peripheral", "Décubitus ventral", ["rachis", "laminectomie", "TLIF", "PLIF", "XLIF"]),
  ...
  s("Appendicectomie", "A", "intermediate", "intermediate", "low", true, "peripheral", "Décubitus dorsal", ["appendicite", "Mac Burney", "McBurney"]),
  ...
  s("Œsophagectomie", "A", "major", "high", "high", true, "intrathoracic", "Décubitus dorsal puis latéral", ["Ivor Lewis", "Akiyama", "œsophagectomie transhiatale"]),
  ...
  s("Résection transurétrale de vessie", "J2", "major", "low", "high", false, "peripheral", "Lithotomie", ["RTUV", "TURB", "TURBT", "tumeur de vessie"]),
  ...
  s("Chirurgie endonasale", "C", "intermediate", "low", "low", false, "peripheral", "Décubitus dorsal, proclive", ["septoplastie", "méatotomie", "turbinoplastie"]),
  ...
  s("Vertébroplastie / cyphoplastie", "K", "minor", "low", "low", false, "peripheral", "Décubitus ventral", ["tassement vertébral", "kyphoplastie"]),
  // Chirurgie générale et digestive
